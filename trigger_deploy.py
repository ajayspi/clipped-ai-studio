...
with sftp.file('/root/deploy_bg.sh', 'w') as f:
    f.write(script)
sftp.close()

# Execute in background
client.exec_command('nohup bash /root/deploy_bg.sh > /root/deploy_bg.log 2>&1 &')
print("Successfully triggered background deployment on server.")
client.close()
