 ...
 *   - One Content (parts[]) â†’ one embedding. Multiple parts in one Content fuse.
 *   - N Content objects / N batchEmbedContents requests â†’ N embeddings.
 ...
 * they must reach generativelanguage.googleapis.com as Content parts â€” do
