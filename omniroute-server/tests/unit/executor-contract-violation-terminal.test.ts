/**
 * #10360 â€” the executor-result contract guard must not hot-loop the router.
 *
 ...
 *    whose `Response` class is NOT `globalThis.Response` â€” so every ordinary
 ...
 *    mapped it to 502 â†’ the connection got cooled down as "rate limited", the
 *    provider breaker counted it, and `processSingleItemWithRetry` (which
 *    retries 429/502/504 up to 200Ã—/24h) span forever. It must surface as a
...
// â”€â”€â”€ 1. Cross-realm Response acceptance â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
test("normalizeExecutorResult accepts a cross-realm Response in the capture-object arm", () => {
  ...
  assert.equal(normalized.url, "http://localhost:20128/v1/chat/completions");
...
// â”€â”€â”€ 2. A genuine violation is terminal, not a transient provider failure â”€â”€â”€â”€
...
test("checkFallbackError treats the contract violation as terminal â€” no retry, no cooldown", () => {
