 ...
 * the auth header entirely â€” both get forwarded to the upstream, producing the
...
// â”€â”€ claude / anthropic â€” empty credentials guard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ claude / anthropic â€” dual-header parity (9router b977bf74) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ claude / anthropic â€” official api.anthropic.com stays x-api-key-only â”€
...
test("claude provider with official api.anthropic.com baseUrl: x-api-key only, no Bearer", () => {
  ...
  const headers = executor.buildHeaders(
    {
      apiKey: "k-official",
      providerSpecificData: { baseUrl: "http://localhost:20128/v1" },
    } as Record<string, unknown>,
    true
  ) as Record<string, string>;
...
// â”€â”€ claude OAuth (accessToken-only) keeps Authorization: Bearer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ existing behavior preserved â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
