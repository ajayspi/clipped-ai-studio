...
// hook: tabitoken (new â€” Claude-first, 2 protocols) and hcnsec (already shipped as an
...
// optional `urlBuilder` and shared.ts grew `buildGeminiGenerateContentUrl` â€” the same builder the
...
// precedence rules) because both providers exist in the static registry â€” the limitation the
...
// â”€â”€ tabitoken â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
test("tabitoken ignores a targetFormat it does not declare", () => {
  const executor = new DefaultExecutor("tabitoken");
  // Unknown alternate â†’ resolveAlternateFormat returns null â†’ default format/route/auth.
...
// â”€â”€ hcnsec â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
test("hcnsec keeps its OpenAI-first defaults and adds the three further protocols it serves", () => {
  ...
  // Unchanged by this extension â€” the guard that adding alternates moved no default.
...
// â”€â”€ shared Gemini URL builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
test("the native gemini provider still resolves its own generateContent route", () => {
  ...
  assert.equal(
    ...
    "http://localhost:20128/v1/models/gemini-3.7-flash:generateContent"
  );
  assert.equal(
    executor.buildUrl("gemini-3.7-flash", true, 0, KEY),
    "http://localhost:20128/v1/models/gemini-3.7-flash:streamGenerateContent?alt=sse"
  );
});

// â”€â”€ dashboard / catalog registration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
test("both hosts surface in the dashboard alternate-protocol picker", () => {
  ...
  // Every alternate needs a label â€” it is the string the picker renders.
...
test("extending hcnsec's protocols leaves its existing catalog classification alone", () => {
  ...
  // is an engine-level capability change â€” it must not silently reclassify the catalog entry
  ...
  assert.equal(
    ...
    false,
    "hcnsec stays a regional provider â€” the protocol extension must not reclassify it"
  );
  ...
  assert.equal(
    gateways.hcnsec,
    undefined,
    "hcnsec must not be duplicated into gateways â€” the families are a strict partition"
  );
});
